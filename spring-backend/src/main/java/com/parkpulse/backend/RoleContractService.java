...
public class RoleContractService {
    ...
    private List<Map<String, Object>> roles() {
        return List.of(
            ...
            role("ops_team", "Ops Team", "command_center", List.of("read_identity_status", "read_ops_evidence", "read_staff_training_analytics", "read_product_learning", "manage_product_learning", "read_venue_profile", "use_accessibility_journey", "read_review_label_pipeline", "record_review_label", "read_experience_studio", "use_experience_studio", "review_experience_studio", "create_park_issue_ticket", "create_training_gap_ticket", "use_ops_chat", "run_agent_orchestration", "dispatch_live_action", "run_live_outcome_cycle")),
            role("ml_ops_admin", "ML / Ops Admin", "learning_governance", List.of("read_identity_status", "read_ops_evidence", "read_platform_status", "read_product_learning", "manage_product_learning", "read_venue_profile", "manage_venue_profile", "use_accessibility_journey", "read_review_label_pipeline", "record_review_label", "read_experience_studio", "use_experience_studio", "review_experience_studio", "create_training_gap_ticket", "use_ops_chat", "run_agent_orchestration", "manage_platform_store", "read_executive_intelligence", "read_ml_training", "start_offline_training", "manage_agent_trust"))
        );
    }
