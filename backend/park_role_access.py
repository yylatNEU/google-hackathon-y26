...
CAPABILITY_MATRIX = {
    ...
    "create_park_issue_ticket": {"customer", "onsite_worker", "ops_team"},
    "create_training_gap_ticket": {"ops_team", "ml_ops_admin"},
    "read_product_learning": {"ops_team", "ml_ops_admin"},
    "read_experience_studio": {"ops_team", "ml_ops_admin"},
    "use_experience_studio": {"ops_team", "ml_ops_admin"},
    "review_experience_studio": {"ops_team", "ml_ops_admin"},
    "manage_experience_studio_core": {"ml_ops_admin"},
    ...
    roles = [
        ...
        _role(
            ...
            [
                ...
                "Experience Studio drafts and audit receipts",
            ],
            [
                "review action",
                ...
                "design and review Experience Studio packages",
            ],
            [
        ...
        _role(
            ...
            [
                ...
                "Experience Studio Core configuration",
            ],
            [
                ...
                "manage Experience Studio Core configuration",
            ],
            [
