...
.PHONY: qa qa-quick qa-backend qa-frontend test-unit test-integration-collect coverage coverage-backend coverage-frontend perf-smoke gcp-bootstrap gcp-local gcp-deploy-private gcp-dev-private gcp-proxy-private gcp-smoke-private gcp-validate-private
