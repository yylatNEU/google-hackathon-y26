...
from agent_role_skills import build_deliberate_role_eval_report  # noqa: E402
...
async def _run() -> int:
    ...
    summary = {
        "status": "passed" if _status_ok(synthetic) and _status_ok(real) and sampled_ok and adversarial.get("status") == "passed" and negative.get("status") == "passed" else "failed",
