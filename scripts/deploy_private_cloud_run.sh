...
COST_PROFILE="${PARKPULSE_COST_PROFILE:-weekly_25}"

if [[ "$COST_PROFILE" == "weekly_25" ]]; then
  ...
  : "${PARKPULSE_GEMINI_REACTION_TIMEOUT_SECONDS:=8}"
  : "${PARKPULSE_GEMINI_REACTION_MAX_OUTPUT_TOKENS:=900}"
